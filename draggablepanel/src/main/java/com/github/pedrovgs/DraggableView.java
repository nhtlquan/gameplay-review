...
limitations under the License. */ package com.github.pedrovgs;
...
public class DraggableView extends RelativeLayout {
	 ...
	 * 
	 * @param enableClickToMaximize
	 *            to enable or disable the click.
	 */
	...
	/**
	 * 
	 * Slide the view based on scroll of the nav drawer. "setEnableTouch" user
	 * prevents click to expand while the drawer is moving, it will be set to
	 * false when the @slideOffset is bigger than MIN_SLIDE_OFFSET. When the
	 * slideOffset is bigger than 0.1 and dragView isn't close, set the dragView
	 * to minimized. It's only possible to maximize the view when @slideOffset
	 * is equals to 0.0, in other words, closed. *
	 * 
	 * @param slideOffset
	 *            Value between 0 and 1, represent the value of slide: 0.0 is
	 *            equal to close drawer and 1.0 equals open drawer.
	 * @param drawerPosition
	 *            Represent the position of nav drawer on X axis.
	 * @param width
	 *            Width of nav drawer
	 */
	 ...
	 * with {@link android.view.MotionEvent#ACTION_CANCEL} action. *
	 * 
	 * @param event
	 *            event to clone
	 * @param action
