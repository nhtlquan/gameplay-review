...
public class DraggablePanel extends FrameLayout {
	 ...
	 * prevents click to expand while the drawer is moving. It's only possible
	 * to maximize the view when @slideOffset is equals to 0.0, in other words,
	 * closed.
	 *
	 * @param slideOffset
	...
	private void initializeAttrs(AttributeSet attrs) {
		...
		this.enableClickToMaximize = attributes.getBoolean(R.styleable.draggable_panel_enable_click_to_maximize_panel,
				DEFAULT_ENABLE_CLICK_TO_MAXIMIZE);
		this.enableClickToMinimize = attributes.getBoolean(R.styleable.draggable_panel_enable_click_to_minimize_panel,
